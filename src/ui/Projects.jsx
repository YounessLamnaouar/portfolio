...
export default function Projects() {
  ...
  return (
    ...
    >
      <h1 data-aos="fade-down" className="text-white font-bold text-5xl md:text-6xl lg:text-8xl lg:mt-20 tracking-tighter text-center mt-4 aclonica-regular">
        Projects
      </h1>
      <p data-aos="fade-down" data-aos-delay="200" className="text-xs text-gray-400 mt-4 aclonica-regular flex flex-row">Swipe left or right to view the projects!</p>
      <div data-aos="fade-up" data-aos-delay="400" className="mt-12 border rounded-3xl md:mt-16 w-full max-w-5xl mx-auto">
        <Carousel
          items={carouselItems}
          baseHeight={480}
          autoplay
